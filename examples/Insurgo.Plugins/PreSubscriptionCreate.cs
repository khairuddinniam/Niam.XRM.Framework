...
{
    public class PreSubscriptionCreate : PluginBase<cr953_subscription>, IPlugin
    {
        public PreSubscriptionCreate(string unsecure, string secure) : base(unsecure, secure)
        {
        }
